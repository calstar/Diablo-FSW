...
public:
    ...
    bool integrateCalibrationData(SensorID sensor_id, 
                                 const Eigen::VectorXd& calibration_params,
...
public:
    ...
    SensorFusion::SensorMeasurement correctMeasurement(const SensorFusion::SensorMeasurement& measurement) const;
