 ...
 */
using EngineControlMessage = MessageFactory<
...
static void set_engine_control_measurement(
    ...
    double thrust_demand,
    double thrust_actual,
    double chamber_pressure,
    double mixture_ratio_demand,
    double mixture_ratio_actual,
    double fuel_valve_position,
    double ox_valve_position,
...
static EngineControlMessage generateTestMessageEngineControl() {
    EngineControlMessage message;
    set_engine_control_measurement(message, 0.0, 0, 0.0, 0.0, 101325.0, 6.0, 6.0, 
