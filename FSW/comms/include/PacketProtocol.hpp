...
public:
    ...
    std::vector<uint8_t> constructCalibrationRequest(SensorType sensor_type, 
                                                    uint8_t sensor_id,
    ...
    bool startListening();
    bool stopListening();
    bool sendPacket(const std::vector<uint8_t>& packet_data, 
                   const std::string& destination_ip, uint16_t port);
...
private:
    ...
    void addSensorToPacket(std::vector<uint8_t>& packet_data, 
...
public:
    ...
    std::vector<uint8_t> buildCalibrationRequestPacket(SensorType sensor_type, 
                                                      uint8_t sensor_id,
